...
best_student_1.rate_lect(lecturer_1, 'Python', 8)
best_student_1.rate_lect(lecturer_1, 'Python', 6)

best_student_2.rate_lect(lecturer_2, 'Python', 10)
best_student_2.rate_lect(lecturer_2, 'Python', 6)
best_student_2.rate_lect(lecturer_2, 'Python', 6)
